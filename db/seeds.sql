...
VALUES
   ...
   ('Heroes of HTML', 'Want to see a mock-up turn intuo an actual webpage in a a matter of minutes? Well, the Heroes of HTML can get it done in a matter of seconds.'),
